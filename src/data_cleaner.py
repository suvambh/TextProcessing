...
class TextProcessing:
    ...
    def save(self):
        ...
        self.df_imported = pd.read_csv('../csv_data_cleaned/normalised.csv')


if __name__ == '__main__':
    file_path = "/Users/suvam/Documents/Text_processing_project/data/Case_study_names_mapping.xlsx"
